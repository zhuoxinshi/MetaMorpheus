...
namespace Test.DIATests
{
    public class Search
    {
        ...
        {
            var filePath1 = @"E:\CE\251016\10-17-25_CE_ammon-acet_PEPPI-YBC_500nL-pHjunction_ISD60-80_preFilter700-900-1100_rep2.raw";
            var fileList = new List<string> { filePath1};
            var outputFolder = @"E:\CE\251016\ISD_search\preFilter_rep2\try1";
            ...
            var ms1XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, 0.25, 3, searchTask.CommonParameters.PrecursorDeconvolutionParameters, 4000, 4, new Bspline(2, 150));
            var ms2XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, 0.25, 3, searchTask.CommonParameters.ProductDeconvolutionParameters, 0, 1, new Bspline(2, 150));
            var pfGroupingEngine = new UmpirePfGroupingEngine(150, 0.1f, 0.2, 0.5, 10, 10);
            searchTask.CommonParameters.DIAparameters = new DIAparameters(AnalysisType.ISD, ms1XicConstructor, ms2XicConstructor, pfGroupingEngine, PseudoMs2ConstructionType.Mass, combineFragments: true);
        ...
        public static void TestBottomUpDIASearch()
        {
            ...
            string baseFolder = @"E:\DIA\SearchResults\TestFile\search1";
            ...
            //{
            //    // Append a short GUID to make the folder name unique
            //    string uniqueSuffix = "_" + Guid.NewGuid().ToString("N").Substring(0, 8);
            //    outputFolder = baseFolder + uniqueSuffix;
            //}
            //Directory.CreateDirectory(outputFolder);

            var ms1XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(5, 1, 1), 1, 0.5, 3, searchTask.CommonParameters.PrecursorDeconvolutionParameters, 0, 1, new Bspline(2, 150));
            ...
            var umpireGroupingEngine = new UmpirePfGroupingEngine(150, 0.2f, 0.2, 0.5, 10, 1, 15, 150);
            ...
            string humanDb = @"E:\Databases\Human_9606.fasta";
        ...
        public static void TestMLSearch()
        {
            ...
            string outputFolder = @"E:\DIA\TestSearch\bottomUp_update\oldData\ML\umpire_try2_balancePerGroup";
            string outFolder2 = @"E:\ISD Project\TestSearch\ISD090625\0918YC\preFilter\ml\try1";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            var ms1XicConstructor = new NeutralMassXicConstructor(new PpmTolerance(10), 1, 0.5, 3, searchTask.CommonParameters.PrecursorDeconvolutionParameters, 0, 1);
            ...
            //var ms1XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, maxPeakHalfWidth: 0.5, 3, searchTask.CommonParameters.PrecursorDeconvolutionParameters, minMass: 5000, minCharge: 5, new Bspline(2, 150));
            ...
            string trainingSamplePath = @"E:\DIA\TestSearch\bottomUp_update\oldData\ML\umpire_try2\TrainingSamples.tsv";
            searchTask.CommonParameters.DIAparameters = new MLbasedDIAparameters(PseudoSearchScanType.DirectSearch, humanDb, searchDecoys: true, ModelType.FastTree, features, 15, existingModelPath: null, existingSampleFilePath: trainingSamplePath, outputFolder, 0.2, apexRtTolerance: 0.3, predictionScoreThreshold: 0.7, AnalysisType.MLbased_bottomUp, ms1XicConstructor, ms2XicConstructor, null, PseudoMs2ConstructionType.MzPeak, writeModel: true, writeTrainingSamples: false, combineFragments: true, useDecoySamples: true);
            var lessGPTMD_toml = @"E:\ISD Project\FB-FD_lessGPTMD\Task Settings\Task3-GPTMDTaskconfig.toml";
            var gptmdTask = Toml.ReadFile<GptmdTask>(lessGPTMD_toml, MetaMorpheusTask.tomlConfig);
            gptmdTask.CommonParameters = searchTask.CommonParameters;
        ...
        {
            var path1 = @"E:\ISD Project\ISD_250906\09-08-25_YB_81min_ISD60-80-100_preFilter700-900-1100_rep1.raw";
            var path2 = @"E:\ISD Project\ISD_250906\09-08-25_YB_81min_ISD60-80-100_sub400-1100_300-100mz.raw";
            var path3 = @"E:\ISD Project\ISD_250906\09-08-25_YB_81min_ISD100_preFilter1100.raw";
            var path4 = @"E:\ISD Project\ISD_250906\09-09-25_YC_81min_ISD60-80-100_preFilter700-900-1100_rep1.raw";
            var path5 = @"E:\ISD Project\ISD_250906\09-10-25_YD_81min_ISD60-80-100_sub400-1100_300-100mz.raw";
            ...
            var outputFolder = @"E:\ISD Project\TestSearch\ISD090625\0908YB\compare\2";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            ...
            var umpireGroupingEngine = new UmpirePfGroupingEngine(150, 0.3f, 0, 0.7, 15, 1, fragmentRankThreshold: 500);
            var xicGroupingEngine = new XicGroupingEngine(0.3f, 0, 0.7, 15, 1, fragmentRankThreshold: 500);
        ...
        {
            var path1 = @"E:\ISD Project\ISD_250906\09-06-25_sigma_DDA_ISD60-80-100_preFilter800-1000-1200.raw";
            ...
            var fileList1 = new List<string> { denoised_test };
            var outputFolder = @"E:\ISD Project\FW-DIA\TestMyData\StdMix\SearchResults";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            ...
            var taskList = new List<(string, MetaMorpheusTask)> { ("search", searchTask) }; //("GPTMD", gptmdTask)
            string standard_xml = @"E:\ISD Project\idmapping_2025_09_17.xml";
        ...
        [Test]
        public static void TestPsmFirst()
        {
            var path = @"E:\ISD Project\ISD_250906\09-18-25_YC_81min_ISD60-80-100_preFilter700-900-1100_rep1.raw";
            var fileList1 = new List<string> { path };

            string tomlFile_CommonFixedVariable = @"E:\CE\250318_CE\0322_YC_SearchOnly\Task Settings\Task1-SearchTaskconfig.toml";
            SearchTask searchTask = Toml.ReadFile<SearchTask>(tomlFile_CommonFixedVariable, MetaMorpheusTask.tomlConfig);
            searchTask.CommonParameters.PrecursorMassTolerance = new PpmTolerance(10);
            var outputFolder = @"E:\ISD Project\TestSearch\ISD090625\psmFirst\1";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            ...
            var ms2XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, maxPeakHalfWidth: 0.5, 3, searchTask.CommonParameters.ProductDeconvolutionParameters, 0, 1, new Bspline(2, 150));//, numberOfPeaksToAdd: 1
            var umpireGroupingEngine = new UmpirePfGroupingEngine(150, 0.3f, 0.3, 0.7, 15, 1, fragmentRankThreshold: 200);
            var xicGroupingEngine = new XicGroupingEngine(0.3f, 0.3, 0.75, 15, 1);
            searchTask.CommonParameters.DIAparameters = new DIAparameters(AnalysisType.ISD_PSM, ms1XicConstructor, ms2XicConstructor, xicGroupingEngine, PseudoMs2ConstructionType.Mass, combineFragments: true);

            var taskList = new List<(string, MetaMorpheusTask)> { ("search", searchTask) }; //("GPTMD", gptmdTask)
            string yeast_xml = @"E:\ISD Project\uniprotkb_taxonomy_id_559292_AND_review_2024_08_16.xml";
            searchTask.CommonParameters.DIAparameters.DbPath = yeast_xml;
            searchTask.CommonParameters.DIAparameters.PsmPath = @"E:\ISD Project\ISD_250906\2025-09-28-12-38-12\Task1-SearchTask\AllPSMs.psmtsv";  
        ...
        public static void CheckXic()
        {
            ...
            var corr2 = PrecursorFragmentsGroup.CalculateXicCorrelation(precursorXic, fragmentXic);
            ...
            corr2 = PrecursorFragmentsGroup.CalculateXicCorrelation(precursorXic, fragmentXic2);
            int stop4 = 4;
        ...
        [Test]
        public static void TestFWDIA()
        {
            var filePath1 = @"E:\ISD Project\FW-DIA\20230727_RPLC_ribosomal_protein_CV20-70V_scan-time_5s_S1_filtered.mzML";
            var fileList = new List<string> { filePath1 };
            var outputFolder = @"E:\ISD Project\FW-DIA\ISD_search\try1";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }

            string tomlFile_Variableonly = @"E:\ISD Project\FW-DIA\DDA\Task Settings\Task1-SearchTaskconfig.toml";

            SearchTask searchTask = Toml.ReadFile<SearchTask>(tomlFile_Variableonly, MetaMorpheusTask.tomlConfig);
            searchTask.CommonParameters.PrecursorMassTolerance = new PpmTolerance(10);
            var ms1XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, 2, 3, searchTask.CommonParameters.PrecursorDeconvolutionParameters, 1000, 3, new Bspline(2, 150));
            var ms2XicConstructor = new NeutralMassXicConstructor(new PpmToleranceWithNotch(20, 2, 2), 2, 2, 3, searchTask.CommonParameters.ProductDeconvolutionParameters, 0, 1, new Bspline(2, 150));
            var pfGroupingEngine = new XicGroupingEngine(1f, 0, 0, 10, 1);
            searchTask.CommonParameters.DIAparameters = new DIAparameters(AnalysisType.ISD, ms1XicConstructor, ms2XicConstructor, pfGroupingEngine, PseudoMs2ConstructionType.Mass, combineFragments: true);

            var taskList = new List<(string, MetaMorpheusTask)> { ("search", searchTask) }; //("GPTMD", gptmdTask), ("Calibration", cali_task),

            string ecoli_fasta = @"E:\ISD Project\FW-DIA\uniprotkb_taxonomy_id_469008_2025_04_24.fasta";
