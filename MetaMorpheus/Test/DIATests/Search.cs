...
namespace Test.DIATests
{
    public class Search
    {
        ...
        public static void TestMLSearch()
        {
            ...
            string outputFolder = @"E:\DIA\TestSearch\bottomUp_update\oldData\ML\umpire_useDecoySamples";
