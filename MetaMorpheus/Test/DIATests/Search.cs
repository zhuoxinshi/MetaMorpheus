...
namespace Test.DIATests
{
    public class Search
    {
        ...
        public static void TestBottomUpDIASearch()
        {
            ...
            string baseFolder = @"E:\DIA\SearchResults\UmpireData\search1";
            ...
            var umpireGroupingEngine = new UmpirePfGroupingEngine(150, 0.2f, 0.2, 0.5, 10, 1, 20, 200);
        ...
        public static void TestISDStandard()
        {
            ...
            var outputFolder = @"E:\ISD Project\TestSearch\ISD090625\sigma\1";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
