...
namespace Test.TestDIA
{
    public class ISDTest
    {
        ...
        public static void TestConstructMs2Groups()
        {
            ...
            string outputFolder = @"E:\ISD Project\TestSearch\isdEngine_cali-avg-FD-RT28.83-32.69_corr0.5_highestPeakXIC_ms1Tol10ppm_apexRT0.5_maxMissed2_overlap0.3_maxRT1.5_300000";
            ...
            task.CommonParameters.DIAparameters = new DIAparameters(new PpmTolerance(10), new PpmTolerance(20),
                ...
                fragmentRankCutOff: 100, precursorRankCutOff: 10, maxRTrangeMS1: 1.5, maxRTrangeMS2: 3, highCorrThreshold: 0.5, numHighCorrFragments: 0,
