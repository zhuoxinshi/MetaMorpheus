...
namespace Test.TestDIA
{
    public class Search
    {
        ...
        public static void TestDIASearch()
        {
            ...
            string outputFolder = @"E:\DIA\TestSearch\scanBased2_corr0.5_highestPeakXIC_cubicSpline_apexRT0.25_noPeakTrim_maxMissed1_overlap0.3_Frank300";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            task.CommonParameters.DIAparameters = new DIAparameters(new PpmTolerance(10), new PpmTolerance(20), 1, 100, 0.3, 0.5, 0.25, 300);
