...
namespace Test.TestDIA
{
    public class Search
    {
        ...
        public static void TestDIASearch()
        {
            ...
            string outputFolder = @"E:\DIA\TestSearch\test_corr0_chargeAdded_noMassRound_highestPeakXIC_cubicSpline_apexRT0.2_PeakTrim_maxMissed2";
            if (!Directory.Exists(outputFolder))
            {
                Directory.CreateDirectory(outputFolder);
            }
            task.CommonParameters.DIAparameters = new DIAparameters(new PpmTolerance(10), new PpmTolerance(20), 2, 100, 0.3, 0, 0.2);
