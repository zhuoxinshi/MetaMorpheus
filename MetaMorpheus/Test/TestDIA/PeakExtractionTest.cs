...
{
    public class GetPeakExtractionTests
    {
        public List<PeakExtractionTestCase> TestCases => GetPeakExtractionTestCases();
        ...
        public List<PeakExtractionTestCase> GetPeakExtractionTestCases()
        {
            Loaders.LoadElements();
            var testCases = new List<PeakExtractionTestCase>();

            // Test Case 1: Fake data with 3 scans
        ...
        [Test]
        public void TestGetAllPeaksByScan()
        {
        ...
        //Test if peakTable is built correctly; peakTable method is copied from FlashLFQ for peak searching in finding XICs
        [Test]
        public void TestPeakTable()
        {
            foreach(var testCase in TestCases)
            {
                ...
                //test if the peakTable has the same number of entries as expected
                ...
                //Test if the peaks in each entry refer to the same objects as the peaks in allPeaksByScan in the correct order
                ...
                //Test if the entries in peakTable are in the correct position
