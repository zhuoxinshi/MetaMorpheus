...
namespace EngineLayer.DIA
{
    ...
    public class XicGroupingEngine : PfGroupingEngine
    {
        ...
        public static PrecursorFragmentsGroup GroupFragmentsForOnePrecursor(ExtractedIonChromatogram precursorXic, IEnumerable<ExtractedIonChromatogram> fragmentXics, double apexRtTolerance, double overlapThreshold, double correlationThreshold, int minFragmentCountForGrouping)
        {
